...
#include "robot_craig_commander/CRGjoints.h"
#include <sstream>
#include "iostream"

class MoveEnable{
  public:
    void cmdCallback(const robot_craig_commander::CRGjoints::ConstPtr& msg);
};
...
moveit_visual_tools::MoveItVisualToolsPtr visual_tools_;
  ...
  void MoveEnable::cmdCallback(const robot_craig_commander::CRGjoints::ConstPtr& msg){
    ...
    moveit::planning_interface::MoveGroupInterface move_group("craig_arm");
    moveit::planning_interface::PlanningSceneInterface planning_scene_interface;
    const robot_state::JointModelGroup* joint_model_group =
        move_group.getCurrentState()->getJointModelGroup("craig_arm");
    ...
    visual_tools_->publishTrajectoryLine(my_plan.trajectory_, joint_model_group->getLinkModel("link6"), joint_model_group, rvt::LIME_GREEN);
...
int main(int argc, char** argv)
{
  ...
  static const std::string PLANNING_GROUP = "craig_arm";
  moveit::planning_interface::MoveGroupInterface move_group(PLANNING_GROUP);

  MoveEnable mv;
  ROS_INFO("Esperando angulos articulares en topico robot_commander/cmd_joint...");
  ros::Subscriber sub = node_handle.subscribe("robot_commander/cmd_joint", 1000, &MoveEnable::cmdCallback, &mv);
